...
import { KeywordConfig } from '../types/index.js';
...
export class KeywordExtractor {
  ...
  extractKeywords(text: string, maxKeywords: number = 10, category?: string): string[] {
  ...
  extractAIKeywords(text: string, maxKeywords: number = 15): string[] {
