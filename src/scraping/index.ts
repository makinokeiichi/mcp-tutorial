...
export class WebScraper {
  ...
  async scrapeUrl(url: string, selectors: Record<string, string>): Promise<ScrapingResult> {
    try {
  ...
  async scrapeMultipleUrls(configs: ScrapingConfig[]): Promise<ScrapingResult[]> {
  ...
  async scrapeWithRetry(url: string, selectors: Record<string, string>, maxRetries: number = 3): Promise<ScrapingResult> {
